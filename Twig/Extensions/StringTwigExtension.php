...
class StringTwigExtension extends AbstractExtension
{
    ...
    public function getFilters() : array
    {
        return [
            ...
            new TwigFilter('truncate', [$this, 'truncate'], ['is_safe' => array('html')]),
        ];
    }
     ...
     * @return string
     */
    public function line(string $value, $line = 1): string
    {
        if (!$value) {
            return '';
        }
     ...
     */
    public function truncate(string $text, $length = 100, $ending = '...', $exact = false, $considerHtml = true)
    {
        if ($considerHtml) {
